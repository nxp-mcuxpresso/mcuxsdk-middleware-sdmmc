...
void CsActivePolarity(sdspi_cs_active_polarity_t polarity)
{
    ...
    {
        DSPI_SetAllPcsPolarity(EXAMPLE_DSPI_MASTER_BASEADDR, 0U);
    }
    else
    {
        DSPI_SetAllPcsPolarity(EXAMPLE_DSPI_MASTER_BASEADDR, DSPI_MASTER_PCS_ACTIVE_LOW);
    }
}
...
void InitHost(void)
{
    ...
    g_host.init             = InitSpi;
    g_host.csActivePolarity = CsActivePolarity;
